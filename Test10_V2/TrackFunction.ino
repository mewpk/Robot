...
void move_line5_countV2(int speedx, int count)
{
  ...
  while (1)
  {
    ...
    if ((digitalRead(Sensor1) == 0 || digitalRead(Sensor5) == 0) && millis() - incout_T > 350)//เจอเส้นตัด จะเช็คเมื่อผ่านไป 400 mS
    {
      debount_in++;
    }
    else
...
int Keep_Object()//หยิบชิ้นงานแล้วหุ่นจะจอดที่จุดวางชิ้นงาน
{
  ...
  motorR(0);
  motorL(0);
  myservo1.write(80);//////90หนีบ 130ปล่อย
  delay(200);
  spin(200);
  spin(200);
  ////////////////////////////////////////////วิ่งไปจับEND
...
int Keep_Object2()//หยิบชิ้นงานแล้วหุ่นจะจอดที่จุดวางชิ้นงาน
{
  ////////////////////////////////////////////วิ่งไปจับSTART
  move_line5_countV3(150, 1);
  motorR(0);
  motorL(0);
  myservo1.write(80);//////90หนีบ 130ปล่อย
  delay(100);
...
int Keep_Object3()//หยิบชิ้นงานแล้วหุ่นจะจอดที่จุดวางชิ้นงาน
{
  ////////////////////////////////////////////วิ่งไปจับSTART
  move_line5_countV2(150, 1);
  motorR(0);
...
int Keep_Object4()//หยิบชิ้นงานแล้วหุ่นจะจอดที่จุดวางชิ้นงาน
{
  ////////////////////////////////////////////วิ่งไปจับSTART
  move_line5_countV2(150, 1);
  motorR(0);
